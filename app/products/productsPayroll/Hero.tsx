...
<div className="absolute inset-0 bg-gradient-to-b from-[#004A80]/30 to-black/15  " />
      ...
      HR and Payroll,
       ...
       Gr8 Payroll & HRIS covers everything from hiring to payroll so <br /> HR can focus on what actually matters
        </p>
