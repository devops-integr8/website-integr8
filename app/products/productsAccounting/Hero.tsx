      ...
      <div className="absolute bottom-10 md:bottom-16 lg:bottom-20 right-0 px-6 md:px-12 lg:px-16 text-white">
        ...
        <div className="flex flex-col items-end gap-2 md:gap-3 max-w-xl">
          ...
          <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold tracking-wide text-right">
            One Place for All Your <br /> Business Finances
          </h1>

          <p className="text-xs sm:text-sm md:text-base max-w-lg leading-relaxed text-right">
       Gr8Books keeps your records, transactions, and reports organized <br /> so you always have a clear picture of your finances.
          </p>
